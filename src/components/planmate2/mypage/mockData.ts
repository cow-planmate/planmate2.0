export const MY_TRAVEL_POSTS = [
  {
    ...
    destination: "서울",
    image:
      "https://images.unsplash.com/photo-1638496708881-cf7fb0a27196?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
    likes: 342,
    comments: 28,
    forks: 156,
    createdAt: "2일 전",
  ...
  },
  {
    ...
    destination: "부산",
    image:
      "https://images.unsplash.com/photo-1679054142611-5f0580dab94f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
    likes: 421,
    comments: 52,
    forks: 278,
    createdAt: "1주 전",
...
export const FORKED_TRAVEL_POSTS = [
  {
    ...
    destination: "제주도",
    image:
      "https://images.unsplash.com/photo-1674606042265-c9f03a77e286?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
...
export const LIKED_TRAVEL_POSTS = [
  {
    ...
    destination: "강릉",
    image:
      "https://images.unsplash.com/photo-1768555520607-cb29f2bc6394?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
    author: "카페러버",
    likedAt: "1일 전",
    likes: 156,
    comments: 12,
