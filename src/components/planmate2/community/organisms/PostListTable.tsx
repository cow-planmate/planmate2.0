...
export const PostListTable = ({ posts, type, onNavigate, page, totalPages, onPageChange, currentPostId }: PostListTableProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="hidden sm:grid grid-cols-[minmax(0,1fr)_132px_100px_64px_64px] items-center gap-2 px-4 py-2.5 bg-[#f7f8fa] border-b border-gray-100 text-[13px] font-bold text-[#6b7280]">
        <span>제목</span>
