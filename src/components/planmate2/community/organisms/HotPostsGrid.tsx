...
export const HotPostsGrid = ({ hotPosts, type, onNavigate }: HotPostsGridProps) => {
  return (
    <section className="mb-4 md:mb-7" aria-labelledby="hot-posts-heading">
      ...
      <div className="-mx-3 flex snap-x snap-mandatory items-stretch gap-2 overflow-x-auto px-3 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:mx-0 md:grid md:snap-none md:grid-cols-3 md:items-start md:gap-3 md:overflow-visible md:px-0 md:pb-0">
